...
<body>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row" style="align-items: center;">
                <div class="col-md-7">
                    <h2>We're here to help you set up your HP printer</h2>
                ...
                <div class="col-md-7 border-end">
                    <div class="page-content">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="" id="setupPrinter"
                                name="printerOption">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="" id="troubleshootPrinter"
                                name="printerOption">
                        ...
                        <div>
                            ...
                            <div class="autocomplete-container">
                                <input id="autocomplete-input" type="text" name="query"
                                    placeholder="Example: HP DeskJet 2632 All-in-One printer" class="form-control">
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="assets/img/printer-working.gif" style="max-height:350px"
    ...
    <section class="py-4">
        <div class="container">
            <div class="col-md-7">
                <p class="mb-0">We’ve made it easy to download HP printer software to set up your printer. Enter your
                    product name and we’ll get you the right printer setup software and drivers. We support all major
                    desktop and mobile operating systems, including Windows, MacOS, iOS, and Android.</p>
            </div>
        </div>
    </section>
